#############################################################################
# Makefile for building: Talker
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  Talker.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile Talker.pro
#############################################################################
...
Makefile: Talker.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/Talker1.0.0 || mkdir -p .tmp/Talker1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Talker1.0.0/ && $(COPY_FILE) --parents Win.h .tmp/Talker1.0.0/ && $(COPY_FILE) --parents main.cpp Win.cpp .tmp/Talker1.0.0/ && (cd `dirname .tmp/Talker1.0.0` && $(TAR) Talker1.0.0.tar Talker1.0.0 && $(COMPRESS) Talker1.0.0.tar) && $(MOVE) `dirname .tmp/Talker1.0.0`/Talker1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Talker1.0.0
...
moc_Win.cpp: /usr/include/qt5/QtWidgets/QApplication \
